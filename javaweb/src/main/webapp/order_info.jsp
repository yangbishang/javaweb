...
<body>
	...
	<div class="container">
		...
		<div>
			<hr />
			<form id="orderForm" class="form-horizontal" action="${pageContext.request.contextPath }/ProductServlet" method="post"
				style="margin-top: 5px; margin-left: 150px;">
				<!-- method的名字 通过表单提交 -->
				<input type="hidden" name="paction" value="updataOrder">
				<!-- 传递订单oid -->
