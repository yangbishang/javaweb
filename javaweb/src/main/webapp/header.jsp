...
<div class="container-fluid">
	...
	<div class="col-md-3" style="padding-top:20px">
		<ol class="list-inline">
			...
			<c:if test="${!empty username }">
				<li style="color:red">欢迎您，${username }</li>
				<li><a href="${pageContext.request.contextPath }/UserServlet?action=logout">退出</a></li>
			</c:if>
			
			<li><a href="cart.jsp">购物车</a></li>
			<li><a href="${pageContext.request.contextPath }/ProductServlet?paction=myOrders">我的订单</a></li>
		</ol>
	</div>
</div>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="ProductServlet?cid=1&paction=allProduct">手机数码</a>
				<a class="navbar-brand" href="ProductServlet?cid=2&paction=allProduct">电脑平板</a>
