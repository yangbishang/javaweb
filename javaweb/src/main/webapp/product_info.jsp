...
<script type="text/javascript">
	function addCart(){
		...
		location.href="ProductServlet?paction=addProductToCart&pid=${product.pid}&buyNum="+buyNum;
	}
		...
		<div class="row">
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div>
						<a href="${pageContext.request.contextPath}/ProductServlet?paction=allProduct&cid=${product.cid }&pageno=${pageno}">返回列表页面</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
